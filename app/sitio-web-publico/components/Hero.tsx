        ...
        >
          <div className="space-y-6">
            <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <span className="text-xs font-medium text-slate-300">Internet Fibra Óptica</span>
            </motion.div>

            <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.1]">
            ...
            <motion.p variants={itemVariants} className="text-base sm:text-lg text-slate-400 max-w-lg leading-relaxed">
              {informacion?.descripcion || "Internet de alta velocidad con fibra óptica. Rápido, estable y con soporte local."}
            </motion.p>
            ...
            <motion.div variants={itemVariants} className="flex gap-8 pt-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <AnimatedCounter end={500} suffix="+" label="Clientes activos" />
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <AnimatedCounter end={99} suffix=".9%" label="Disponibilidad" />
                </div>
              </div>
            </motion.div>
          </div>
          ...
          {/* Mobile indicators */}
          <motion.div variants={itemVariants} className="lg:hidden flex justify-center gap-3 pt-2">
